...
const SignIn = () => {
  ...
  return (
    <div className=' h-screen flex justify-center items-center'>
       <div className="w-full max-w-md p-8 shadow-2xl space-y-3 rounded-xl  dark:text-gray-800">
	...
	<form onSubmit={handleSubmit(onSubmit)}  action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm text-white bg-[#0fa968]">Sign in</button>
	</form>
		...
		<button aria-label="Log in with GitHub" className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
                  <Link to='/signUp' className=" underline cursor-pointer  text-[#0fa968]" >Sign up</Link>
