...
const Modal = () => {
	const {googleSignIn,SignUp} = useContext(FireBaseContext)
  const {
    register,
    handleSubmit,
    watch,
...
<dialog id="my_modal_3" className="modal">
  <div className="modal-box">
	...
	<form onSubmit={handleSubmit(onSubmit)}  action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm text-white bg-[#0fa968]">Sign Up</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-400">Already have an account?
              <a onClick={() => document.getElementById("my_modal_2").showModal()} rel="noopener noreferrer" href="#" className="  text-[#0fa968]">Please click outside</a>
